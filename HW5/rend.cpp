					...
					if (!(AfDiff1 < 0 || AfDiff2 < 0 || AfDiff3 < 0)){
						...
						if (anZ == 0 || anInterZ < anZ)
						{
							...
							else if (render->interp_mode == GZ_COLOR)
							{
								...
								float tempU = -((afCoVariantUA*anCntRangeX + afCoVariantUB * anCntRangeY + afCoVariantUD) / afCoVariantUC);
								float tempV = -((afCoVariantVA*anCntRangeX + afCoVariantVB * anCntRangeY + afCoVariantVD) / afCoVariantVC);
